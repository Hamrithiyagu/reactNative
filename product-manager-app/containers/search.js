...
class SearchWithFlatList extends Component {
	...
	_getMore = () => {
        this.props.actions.getsearch(++this.props.page, this.props.limit, this.state.searchText);
	};
	...
	searchHandler = (text) => {
		this.setState({ searchText: text }, () => {
			this.props.actions.getsearch(1, this.props.limit, this.state.searchText);
		});
	};
...
function mapStateToProps(state) {
	return {
		products: state.searchState.searchsuccess,
